...
public class RicercaFattureGUI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RicercaFattureGUI frame = new RicercaFattureGUI();
	 ...
	 * Create the frame.
	 */
	public RicercaFattureGUI() {
		setResizable(false);
		
		
		
		setTitle("Ricerca Fatture Vendite");
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					if(!dataDa.equals("") && !dataA.equals("")) {
						...
						RisultatiFattureVenditeGUI risFatture = new RisultatiFattureVenditeGUI(codice, daFormattata, aFormattata, "");
						risFatture.setVisible(true);

					}else {
						RisultatiFattureVenditeGUI risFatture = new RisultatiFattureVenditeGUI(codice, "", "", "");
						risFatture.setVisible(true);
					...
					JOptionPane.showMessageDialog(RicercaFattureGUI.this,  "Errore: " + e, "Errore", JOptionPane.ERROR_MESSAGE);
				}
			}
		});
		...
		lblRicercaOrdini = new JLabel("Ricerca Fatture Vendite");
		lblRicercaOrdini.setFont(new Font("Tahoma", Font.BOLD, 16));
		lblRicercaOrdini.setBounds(127, 36, 242, 14);
